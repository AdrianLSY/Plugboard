...
`.claude/` is outside the grant. It is a vendored agent harness: six of its thirty-one skills
declare a licence, and the other twenty-five plus all six slash commands declare none — the defect
