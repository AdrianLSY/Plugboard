...
Note: design decisions D1–D20 predate this setup and live in `openspec/changes/rebuild-plugboard/design.md`, which wins over `docs/` where they disagree. New ADRs must not silently contradict them; the D20 vocabulary (*instance* / *installation* / *node*) is the glossary seed for `CONTEXT.md`.
