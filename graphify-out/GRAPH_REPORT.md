...
## Corpus Check
- 210 files · ~106,341 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 760 nodes · 1127 edges · 82 communities (46 shown, 36 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 99 edges (avg confidence: 0.82)
...
- This refresh has 0 missing endpoints, 0 dangling endpoints, 0 self-loops, and 0 additional same-endpoint collapses in its merged extraction.
...
Cohesion: 0.08
Nodes (44): Exactly one decision register, Generated indexes cannot drift, Alternatives to Plugboard, Cloudflare Tunnel, Dynamic-configuration reverse proxy, frp, Tailscale Funnel, Multi-tenant platform ingress (+36 more)

### Community 5 - "Repository Checks and PRs"
Cohesion: 0.08
Nodes (41): Dependabot GitHub Actions updates, Weekly GitHub Actions dependency updates, Pull request template, Wire contract impact declaration, Vault check workflow, DCO sign-off workflow, Contract change guard, Dependabot auto-merge workflow (+33 more)
...
Cohesion: 0.15
Nodes (27): Body octets end to end, Ordered header-field pairs, Banned patterns index, Typed wire error codes, Opaque method token, Dedicated proxied-traffic pipeline, Chunkwise proxied-body emission, Per-hop framing authority (+19 more)
...
Cohesion: 0.11
Nodes (23): Component test workflow, Conformance build job, Fast test job, Expected-outcome gating tests, Integration test job, Component lint job, Python tooling CI job, All violations in one run (+15 more)
